...
# Uses Cases
So you're probabling asking yourself, why would I need to use SparkR to run my Shiny applications?. That is a legitimate question. But before we answer it, let's first describe the classes of big data problems.
...
![App without the results](img/no-result.png)
...
4. **Stage 4:** When you change the input values in the app and click the "Predict Sepal Length" button, the application uses the alreading exciting Spark Context to run the predict function and displays the predicted. This operations takes a shorter time than the initial launch of the shiny app.
